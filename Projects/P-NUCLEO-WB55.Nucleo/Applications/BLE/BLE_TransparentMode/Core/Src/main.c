...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, LED_RED_2_Pin|LED_GREEN_2_Pin|LED_GREEN_1_Pin|LED_RED_1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MCU_KILL_GPIO_Port, MCU_KILL_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MCU_WIRELESS_PWR_nEN_GPIO_Port, MCU_WIRELESS_PWR_nEN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : MCU_CHG_nDISABLE_Pin */
  GPIO_InitStruct.Pin = MCU_CHG_nDISABLE_Pin;
  ...
  /*Configure GPIO pin : MCU_SWITCH_INT_Pin */
  GPIO_InitStruct.Pin = MCU_SWITCH_INT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(MCU_SWITCH_INT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : MCU_KILL_Pin */
  GPIO_InitStruct.Pin = MCU_KILL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MCU_KILL_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : MCU_WIRELESS_PWR_nEN_Pin */
  GPIO_InitStruct.Pin = MCU_WIRELESS_PWR_nEN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MCU_WIRELESS_PWR_nEN_GPIO_Port, &GPIO_InitStruct);
